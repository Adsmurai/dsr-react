 ...
 *
 * @description
 * A right-click context menu component built on Radix UI Context Menu primitive.
 * Displays a menu when users right-click on a trigger element, providing contextual
 * actions relevant to the clicked item. Supports submenus, checkboxes, radio groups,
 * separators, and keyboard shortcuts.
 *
 * @example
 * ```tsx
 * import {
 ...
 *   </ContextMenuTrigger>
 *   <ContextMenuContent>
 *     <ContextMenuCheckboxItem checked={showStatus}>
 *       Show Status Bar

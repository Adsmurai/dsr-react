 ...
 *
 * @description
 * An application menubar component built on Radix UI Menubar primitive.
 * Provides a horizontal menu bar typically used at the top of applications,
 * containing dropdown menus for file operations, edit actions, view options, etc.

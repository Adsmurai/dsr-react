 ...
 *
 * @description
 * Modal dialog for important confirmations that interrupt the user.
 * Use for destructive actions like delete, or critical decisions.
 * Built on Radix UI AlertDialog primitive.
 *
 * @when_to_use
 * - Confirming destructive actions (delete, remove)
 * - Critical user decisions that can't be undone
 * - Actions requiring explicit user acknowledgment
 *
 * @when_not_to_use
 * - Simple informational messages → use Toast
 * - Non-critical confirmations → use Dialog
 * - Inline feedback → use Alert component
 *

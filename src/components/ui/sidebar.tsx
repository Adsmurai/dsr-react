 ...
 *
 * @description
 * A comprehensive sidebar navigation system built on Radix UI primitives.
 * Provides collapsible navigation with support for mobile (sheet-based) and
 * desktop (fixed) layouts. Includes keyboard shortcuts (Ctrl/Cmd + B) and
 ...
 *
 * @when_to_use
 * - Application layouts requiring persistent navigation
 * - Admin dashboards and control panels
 * - Multi-level navigation hierarchies
 * - Layouts needing responsive mobile/desktop navigation
 *
 * @when_not_to_use
 * - Simple single-page applications
 * - Marketing landing pages
 * - For temporary menus, use DropdownMenu or Sheet instead
 *
 * @example
 * ```tsx
 * import {
...
/**
 * Available sidebar visual variants.
 * - `sidebar`: Default fixed sidebar with border
 * - `floating`: Floating sidebar with shadow and rounded corners
 * - `inset`: Inset sidebar with background color
 */
export const SIDEBAR_VARIANTS = ['sidebar', 'floating', 'inset'] as const;

/**
 * Available sidebar collapsible modes.
 * - `offcanvas`: Slides completely off screen when collapsed
 * - `icon`: Collapses to icon-only width (shows only icons)
 * - `none`: Non-collapsible, always expanded
 */
export const SIDEBAR_COLLAPSIBLE_MODES = ['offcanvas', 'icon', 'none'] as const;

/**
 * Available sidebar menu button variants.
...
/**
 * Available sidebar menu button sizes.
...
/** Type for sidebar side values */
export type SidebarSide = (typeof SIDEBAR_SIDES)[number];

/** Type for sidebar variant values */
export type SidebarVariant = (typeof SIDEBAR_VARIANTS)[number];

/** Type for sidebar collapsible mode values */
export type SidebarCollapsibleMode = (typeof SIDEBAR_COLLAPSIBLE_MODES)[number];

/** Type for sidebar menu button variant values */
export type SidebarMenuButtonVariant = (typeof SIDEBAR_MENU_BUTTON_VARIANTS)[number];

/** Type for sidebar menu button size values */
